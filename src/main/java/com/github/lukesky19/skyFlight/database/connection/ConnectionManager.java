...
*/
package com.github.lukesky19.skyFlight.database.connection;
...
public class ConnectionManager extends AbstractConnectionManager {
    /**
     * Constructor
     * @param skyFlight The plugin's main instance.
     */
    public ConnectionManager(@NotNull SkyFlight skyFlight) {
        super(skyFlight);
    }
